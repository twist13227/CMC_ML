...
def run_single_test(data_dir, output_dir):
    spec = importlib.util.spec_from_file_location(
        "tests", os.path.join(data_dir, "test.py")
    )
...
def grade(data_dir):
    ...
    tests_names = [
        "public/00_test_kmeans_classifier",
        "public/01_test_kmeans_classifier",
        "public/02_test_kmeans_classifier",
        "public/03_test_kmeans_classifier",
        "public/04_test_kmeans_classifier",
        "public/05_test_kmeans_classifier",
        "public/06_test_kmeans_classifier",
        "public/07_test_kmeans_classifier",
        "private/00_test_kmeans_classifier",
        "private/01_test_kmeans_classifier",
        "private/02_test_kmeans_classifier",
        "private/03_test_kmeans_classifier",
        "private/04_test_kmeans_classifier",
        "private/05_test_kmeans_classifier",
        "private/06_test_kmeans_classifier",
        "private/07_test_kmeans_classifier",
        "private/08_test_kmeans_classifier",
        "private/09_test_kmeans_classifier",
        "private/10_test_kmeans_classifier",
        "private/11_test_kmeans_classifier",
        "private/12_test_kmeans_classifier",
        "private/13_test_kmeans_classifier",
        "private/14_test_kmeans_classifier",
        "private/15_test_kmeans_classifier",
        "private/16_test_kmeans_classifier",
        "private/17_test_kmeans_classifier",
        "private/18_test_kmeans_classifier",
        "private/19_test_kmeans_classifier",
    ]
